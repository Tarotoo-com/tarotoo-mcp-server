...
The embedded `data/cards.json` comes from [tarotoo-tarot-dataset](https://github.com/Tarotoo-com/tarotoo-tarot-dataset) (CC BY 4.0), also available on Hugging Face and Kaggle. Interpretations are grounded in A. E. Waite's *The Pictorial Key to the Tarot* (1911, public domain), written in Tarotoo's editorial voice.
