...
Published by [Tarotoo](https://tarotoo.com) as part of its [AI transparency initiative](https://tarotoo.com/card-meanings-dataset): these are the same card meanings that ground the AI readings on Tarotoo.com.
